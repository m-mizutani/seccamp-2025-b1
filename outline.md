...
- **🎯 カスタム検知が必要な実例とビジネスケース** (10分)
  ...
  - **実例2：フェーズ3（無敗大学）での学籍データ保護**
    ...
    → カスタム検知：役職 + 時期 + アクセスパターン = FERPA違反リスク検知
    ```
...
#### 9:30-9:50 - (#3) セキュリティ監視基盤の統合と段階的構築 (20分)
...
#### 11:10-12:00 - (#6) 課題2 検知用SQLの作成と実行 (60分)
...
- **脅威シナリオ設計と検知SQL作成** (25分)
  - **🏫 無敗塾ベースの脅威シナリオ選択** (8分)
    - **フェーズ3シナリオ**: 講師の試験期間外成績データアクセス
    - **フェーズ4シナリオ**: 外部講師のAI学習データ権限外アクセス  
    - **フェーズ5シナリオ**: 海外リージョンからの管理者権限使用
