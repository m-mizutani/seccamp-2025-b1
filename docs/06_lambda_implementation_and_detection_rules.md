...
ここからは、実際にセキュリティイベントを検知するSQLクエリを作成していきます。

**課題の進め方**
- **Required**: パターン1〜4から1つ選択し検知ルールを実装、デプロイする
- **Optional**: パターン1〜4をすべて実装、デプロイする
- **Optional**: 自分で攻撃パターンの仮説をたてて検知ルールを作成、デプロイする（これは何も検知されなくてもOK）
